(function($) {
  ...
  var printDate = new Date()
    ...
    .slice(0, 10)
    .replace(/-/g, ".");
  $("#start-date-save").val(printDate);
  // var endDate;
  $("#start-date-save").datepicker({
    format: "yyyy.mm.dd",
    i18n: {
      months: [
        "1-р сар",
  ...
  $("#start-date-save").change(function() {
    printDate = $(this).val();
    render_result();
  });
  /*
  ...
  */
  var amountSlider = document.getElementById("amount-save");
  var amountInput = $("#amount-input-save");
  ...
  */
  var hvvSlider = document.getElementById("hvv-save");
  var hvvInput = $("#hvv-input-save");
  ...
  */
  var amountMonthly = document.getElementById("amount-monthly-save");
  var amountMonthlyInput = $("#amount-monthly-input-save");
  ...
  */
  var month = document.getElementById("month-save");
  var monthInput = $("#month-input-save");
  ...
  function render_result() {
    ...
    $("#result-table-save").html(result);
  }
  // SWITCH TYPE
  const hvvContainer = $("#hvv-container-save");
  const valType = $("#save-val-type-save");
  const valTypeMin = $("#save-min-val-type-save");
  const valOption = $("#type-val-save");
  const valMinOption = $("#type-val-min-save");

  const amountMonthlyContainer = $("#amount-monthly-container-save");
  const saveTypeContainer = $("#save-type");
  const saveType = $("#save-type-select-save");
  const durationContainer = $("#duration-save");

  // Main type
  $("#type-save").on("change", function() {
    var value = $(this).val();
    switch (value) {
      // Энгийн тооцоолуур
      case "0":
        ...
        $("#row-total-save").show();
        $("#result-total-container-save").show();
        valType.hide();
      ...
      case "4":
        ...
        valType.hide();
        $("#result-total-container-save").hide();
        $("#row-total-save").hide();
